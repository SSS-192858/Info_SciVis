...
d3.json("Accident_Types.json", function(error, accidents) {

    const color = d3.scaleOrdinal()
      .domain(["Distraction","Car Defects","Substance Abuse","Driver not at fault","Driver Inexperience","Medical/Fatigue","Traffic Rule Violation"])
      .range([ "blue", "black", "red","orange","brown","pink","green"])
    // const color ={
    //     "MID NIGHT" : "orange",
    //     "MORNING" : "#00FF00",
    //     "NIGHT" : "#FF0000",
...
foreground = svg.append("g")
    ...
    .style("stroke", function (d) { 
        ...
        return color(d["MAJOR ACCIDENT TYPE 1"]); })
    .attr("d", path);
